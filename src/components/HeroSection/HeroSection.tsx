...
export default function HeroSection() {
	return (
		<section className="mx-auto max-w-[90rem] flex flex-col items-center w-full relative h-[48.875rem] md:h-auto px-4 pt-4">
...
function HeroContent() {
	return (
		<div className="flex flex-col items-center mt-[3.375rem] justify-center" role="main">
			<h2 className="font-primary text-white text-[2.8125rem] md:text-[1.5rem] font-bold text-center">
				Helping Others
			</h2>
			<h1 className="font-primary text-white text-[5rem] md:text-[2.5rem] font-bold text-center">
				LIVE & TRAVEL
			</h1>
...
function FlightSearchForm() {
	...
	return (
		<aside
			className="w-full text-blackishGreen max-w-[77rem] z-50 mt-[-6.25rem] md:mt-[-2rem] bg-white px-8 pt-4 pb-8 rounded-2xl md:px-4"

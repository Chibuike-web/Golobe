				...
				<div className="flex mt-[40px]">
					<div className="border-[#EAEAEA] border-[1px] bg-white w-full flex rounded-[1rem] overflow-hidden">
						...
						<div className="bg-white w-full max-w-[610px] relative">
							<div className="bg-mintGreen p-6 flex items-center justify-between">
								...
								<h4 className="w-full max-w-[228px] text-right text-[14px] font-primary font-bold">
...
const InfoItem = ({ icon: Icon, label, value }: InfoItemProps) => {
	return (
		<div className="flex gap-2 items-center">
			<figure className={`w-8 h-8 bg-[#EBF6F2] flex justify-center items-center`}>
				<Icon />
			</figure>
			<div>
